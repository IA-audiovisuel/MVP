...
#  llm_graph_read="google/gemma-3-27b-it"

OPENROUTER_MODEL_graph_creation="deepseek-ai/DeepSeek-V3.1"
# llm_graph_read="deepseek/deepseek-chat-v3-0324"
llm_graph_read="deepseek-ai/DeepSeek-V3.1"
...
def create_graphdb(
    ...
    OPENROUTER_MODEL_graph_creation: str=OPENROUTER_MODEL_graph_creation,
    llm_graph_read: str=llm_graph_read
):
        ...
        # feedback nouveau doc
            ...
            yield {
                "pipeline_args": {
                    ...
                    "llm_graph_QA": llm_graph_read,
                }
            }

def load_existing_graphdb(
        doc_name: str, 
        llm_graph_read: str=llm_graph_read,
